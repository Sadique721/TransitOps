...
import com.transitops.security.RateLimitFilter;
...
public class SecurityConfig {
    ...
    // MEDIUM FIX: was hardcoded to "*" (allows any site to make credentialed
    // requests). Now a configurable allow-list — see application.yml `cors.allowed-origins`.
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            // HIGH FIX: basic rate limiting, applied before auth so it protects
            // unauthenticated endpoints (e.g. /auth/login) too.
